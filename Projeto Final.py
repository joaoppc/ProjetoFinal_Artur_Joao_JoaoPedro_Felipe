# -*- coding: utf-8 -*-
"""
Created on Thu May 28 09:02:38 2015

@author: Felipe
"""
class Aluno:
    def __init__(self,Esporte_ind,Preferência_ind,Música_ind,Instrumentos_ind,Entidades_ind):
        self.Esporte_ind =[]
        self.Preferência_ind =[]
        self.Música_ind =[]
        self.Instrumentos_ind = []
        self.Entidades_ind =[]
